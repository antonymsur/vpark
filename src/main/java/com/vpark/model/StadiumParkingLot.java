...
public class StadiumParkingLot extends ParkingLot {
    ...
    private static org.slf4j.Logger logger = LoggerFactory.getLogger(StadiumParkingLot.class);

    public StadiumParkingLot(Builder.ParkingLotBuilder builder) {
        this.name = Constants.STADIUM_NAME;
    ...
    @Override
    public int getTotalSlots(ValueTypes.SlotType type) {
        return parkingSlots.get(type).intValue();
    }

    @Override
    public int getAvailableSlots(ValueTypes.SlotType type) {

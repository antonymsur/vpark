...
public class AirportParkingLot extends ParkingLot {
    ...
    private static org.slf4j.Logger logger = LoggerFactory.getLogger(AirportParkingLot.class);
    

    public AirportParkingLot(Builder.ParkingLotBuilder builder) {
        this.name = Constants.AIRPORT_NAME;
